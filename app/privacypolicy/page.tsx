    ...
    <main>
      ...
      <section className="hero-heading-right-copy">
        ...
        <p className="paragraph-9">
          This "Privacy Policy" (or "<strong>Privacy Policy</strong>") applies to www.alphamizer.io ("Site"), which is owned and operated by Alphamizer Analytics, Inc. ("Company" or "we" or "us"), app.alphamizer.io, and the various websites, services, and applications which are accessed thereby (collectively with the Site, the "Service"). This Privacy Policy explains how we collect, use and disclose personally identifying information ("Personal Information") gathered through the Service. This Privacy Policy is subject to and incorporates by reference the Terms of Use (located at: alphamizer.io/terms-of-use).
        </p>
