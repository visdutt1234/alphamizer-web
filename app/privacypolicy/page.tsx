  ...
  return (
    <main>
      ...
      <section className="hero-heading-right-copy">
        <h1 className="heading-4">Privacy Policy</h1>
        <p className="paragraph-9">
          This &ldquo;Privacy Policy&rdquo; (or &ldquo;<strong>Privacy Policy</strong>&rdquo;) applies to www.alphamizer.io (&ldquo;Site&rdquo;), which is owned and operated by Alphamizer Analytics, Inc. (&ldquo;Company&rdquo; or &ldquo;we&rdquo; or &ldquo;us&rdquo;), app.alphamizer.io, and the various websites, services, and applications which are accessed thereby (collectively with the Site, the &ldquo;Service&rdquo;). This Privacy Policy explains how we collect, use and disclose personally identifying information (&ldquo;Personal Information&rdquo;) gathered through the Service. This Privacy Policy is subject to and incorporates by reference the Terms of Use (located at: alphamizer.io/terms-of-use).
        </p>
